...
| `tools/` | resource-fork parser, trap table, disassembler, PICT decoder, `extract.sh` |
...
- The About logo is `PICT_128.png`. The Help and Info PICTs are text: see `resources/PICT_dump.txt`.
